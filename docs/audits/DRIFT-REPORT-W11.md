...
| L-04 | P1 | MEX-4 CI guard (exchange-specific terms forbidden in core) still deferred. | `docs/rfcs/RFC-0010-W9-multi-exchange-readiness.md:76`, `scripts/ci/check-domain-isolation.sh:109` | `RESOLVED (2026-02-13)`: deterministic grep guard integrated in `invariants-check`. |
