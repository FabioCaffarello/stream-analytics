// Package main is the market-raccoon signals binary.
//
// The signals service consumes market/evidence envelopes and emits canonical
...
func main() {
	...
	if prob != nil {
		fmt.Fprintf(os.Stderr, "signals: config error: %v\n", prob)
		os.Exit(1)
	}
