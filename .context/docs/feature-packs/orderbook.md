...
- `internal/core/aggregation/domain/orderbook.go:132` (ApplyDelta — seq monotonicity + crossed check)
- `internal/core/aggregation/app/update_orderbook.go:101` (Execute — usecase entry)
- `internal/core/aggregation/ports/ports.go:12` (ArtifactPublisher — snapshot/inconsistency publish port)
- `internal/actors/aggregation/runtime/processor.go:226` (handleBookDelta — actor bridge)
- `internal/core/aggregation/app/golden_replay_test.go:40` (golden replay coverage)
