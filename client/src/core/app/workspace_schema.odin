...
// S45: Workspace State Schema — canonical contract for persisted vs derived state.
//
// WORKSPACE_SCHEMA_VERSION is bumped on every persistence format change.
// Current format: V6 (extends V5 with per-cell chart display state).
//
// --- Persisted Per-Cell Fields (V6 layout string) ---
//   widget_kind       Widget_Kind enum (0-8)
...
// Unpack chart display integer into Chart_Component fields.
