...
// S59: Tests for session_health_parse_json — validates deserialization of the
// backend-owned session dashboard read model.

@(test)
test_session_health_parse_ready :: proc(t: ^testing.T) {
	...
	result: Session_Health_Result
	ok := session_health_parse_json(data, &result)
...
@(test)
test_session_health_parse_degraded :: proc(t: ^testing.T) {
...
@(test)
test_session_health_parse_not_ready :: proc(t: ^testing.T) {
...
@(test)
test_session_health_parse_artifact_coverage_partial :: proc(t: ^testing.T) {
...
@(test)
test_session_health_parse_empty_data :: proc(t: ^testing.T) {
	result: Session_Health_Result
	ok := session_health_parse_json(nil, &result)
	testing.expect(t, !ok, "nil data should fail")
}

@(test)
test_session_health_parse_invalid_json :: proc(t: ^testing.T) {
...
@(test)
test_session_health_parse_nil_result :: proc(t: ^testing.T) {
	...
	data := transmute([]u8)json
	ok := session_health_parse_json(data, nil)
