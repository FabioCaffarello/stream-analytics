...
func DefaultBackpressurePriorities() map[string]int {
	return map[string]int{
		...
		"execution.event":                        66,
		"portfolio.state":                        64,
		"insights.volume_profile_snapshot":       20,
		"insights.volume_profile_delta":          20,
		"insights.heatmap_delta":                 55,
		"insights.session_volume_profile":        18,
		"insights.tpo_profile":                   18,
		"insights.fused_volume_profile_snapshot": 15,
		"insights.fused_heatmap_snapshot":        15,
	}
}
