module github.com/FabioCaffarello/stream-analytics/cmd/processor
...
require (
	...
	github.com/FabioCaffarello/stream-analytics/internal/application v0.0.0 // indirect
	github.com/FabioCaffarello/stream-analytics/internal/core/delivery v0.0.0 // indirect
